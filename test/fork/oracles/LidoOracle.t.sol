...
import { IWstETH } from "src/oracles/lido/IWstETH.sol";
import { ChainlinkMultiOracle } from "src/oracles/chainlink/ChainlinkMultiOracle.sol";
import { CompositeMultiOracle } from "src/oracles/composite/CompositeMultiOracle.sol";
import { LidoOracle } from "src/oracles/lido/LidoOracle.sol";
import { ChainlinkAggregatorV3Mock } from "src/mocks/oracles/chainlink/ChainlinkAggregatorV3MockEx.sol";
import { ERC20Mock } from "src/mocks/ERC20Mock.sol";
import { WETH9Mock } from "src/mocks/WETH9Mock.sol";
import { USDCMock } from "src/mocks/USDCMock.sol";
import { WstETHMock } from "src/mocks/oracles/lido/WstETHMock.sol";
import { TestConstants } from "../../utils/TestConstants.sol";

contract LidoOracleTest is ForkTest, TestConstants, AccessControl {
    ...
    function setUp() public {
        ...
        vm.rollFork(forkId, block.number);
