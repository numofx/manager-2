...
abstract contract ZeroState is ForkTest, TestConstants {
    ...
    function setUpHarness(string memory network, uint256 forkId) public {
        vm.rollFork(forkId, 16877055);
    ...
    function setUp() public virtual {
        ...
        else setUpHarness(network, forkId);
    }
